...
\begin{table}[H]
	...
	\begin{tabular}{|c|c|}
		...
		\hline 
		Voltímetro de bobina móvil &  (0-150) V\\  
		\hline 
		Amperímetro de bobina móvil &(0-1.2) A ó (0-6) A \\ 
		\hline
        ...
        &carga 100\%\\
        \hline
        \multirow{5}{3cm}{Generador DC} & 3KV\\ 
        \cline{2-2}
        & 125 V \\
        \cline{2-2}
        &26,5 A\%\\
...
\begin{enumerate}
    ...
    \item Se ajusta $U$ inicialmente sin carga hasta alcanzar $U_{nom}$ con $I_{ext}$, una vez alcanzado $U_{nom}$ se registra el valor.
...
\begin{enumerate}
    \item Se toman las medidas a $I_a$ nominal y N nominal con tensión de armadura e I de campo constante.
    \item Se eleva hasta su carga nominal agregandole un dispositivo fisico.
    \item Se registran los datos.
\end{enumerate}
\subsection{Pérdidas en vacío}
\begin{enumerate}
    \item Para calcular las perdidas en el vacio se deben realizar medidas en dos velocidades distintas anotando los valores de corriente y tensión asociados.
\end{enumerate}
\section{Diagramas}
\begin{figure}[H]
    \centering
